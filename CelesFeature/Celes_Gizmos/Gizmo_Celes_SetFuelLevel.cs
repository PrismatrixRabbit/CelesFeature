...
{
    public class Gizmo_Celes_SetFuelLevel : Gizmo_Slider
    {
        private Comp_Celes_Refuelable refuelable;
        ...
        public Gizmo_Celes_SetFuelLevel(Comp_Celes_Refuelable refuelable)
        {
