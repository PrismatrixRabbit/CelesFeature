...
{
    public class Celes_Recipe_AddHediff : Recipe_Surgery
    {
        ...
        public bool IsValidNow(Thing thing, BodyPartRecord part = null, bool ignoreBills = false)
        {
            ...
            if (pawn.health.hediffSet.HasHediff(Celes_HediffDefOf.Celes_NanoImplanted_II) || pawn.health.hediffSet.HasHediff(Celes_HediffDefOf.Celes_NanoImplanted_I)||pawn.health.hediffSet.HasHediff(Celes_HediffDefOf.Celes_NanoImplanted_III)||pawn.health.hediffSet.HasHediff(Celes_HediffDefOf.Celes_NanoImplanted_IV))
            {
                return false;
            }
            return true;
    ...
    public class Celes_DegradedCyberneticSurgery : Recipe_Surgery
    {
        public override bool AvailableOnNow(Thing thing, BodyPartRecord part = null)
        {
            return IsValidNow(thing, part);
        ...
        public bool IsValidNow(Thing thing, BodyPartRecord part = null, bool ignoreBills = false)
        {
            ...
            if (!pawn.health.hediffSet.HasHediff(Celes_HediffDefOf.Celes_NanoImplanted_III))
            {
                return false;
            }
            return true;
